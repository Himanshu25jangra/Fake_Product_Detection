function getLazarSoftScanner() {
    ...
    (A.imagedata = null),
      ...
      (A.setWebcam = function (e) {
        ...
        t.getUserMedia
          ...
          : t.mozGetUserMedia &&
            ((A.moz = !0),
            t.mozGetUserMedia({ video: n, audio: !1 }, A.vidSuccess, A.vidError));
      }),
      (A.decode = function (e) {
            ...
            value: function (b, c, d, e) {
              ...
              var m = function (a, b) {
                ...
                p = function (a) {
                  return new Promise(function (b, c) {
                    ...
                    if (((g._localMediaStream = a), !h.aspectRatio)) d();
                    else {
              ...
              return new Promise(function (a, c) {
                if (
                  ...
                  var d = g._createVideoConstraints(b);
                  navigator.mediaDevices
              ...
              return new Promise(function (f, g) {
                ...
                (h.onload = function () {
                  ...
                  if (c) {
                    ...
                    (o.style.display = "inline-block"),(o.style.margin = "16px auto"), k.appendChild(o);
  ...
  _defineProperty(Html5Qrcode, "DEFAULT_WIDTH", 300),
    ...
    _defineProperty(Html5Qrcode, "FILE_SCAN_MIN_HEIGHT", 200),
      ...
      _createClass(a, [
        ...
        },
        {
          ...
          value: function (a) {
            (a.style.position = "relative"),
              (a.style.padding = "0px"),
              (a.style.boxShadow = "0 0 0 1px  #eee"),
        ...
        },
        {
          ...
          g.addEventListener("click", function () {
               ...
               // added to call this method on load for the first time
              g.click();
              f.appendChild(g),
              e.appendChild(f);
        ...
        },
        {
          ...
          value: function (b) {
            ...
            (o.innerHTML = "Stop Scanning"),
              ...
              // added to call this method on load if the camera permission is granted
              n.click();
